...
public class Main {
    public static void main(String[] args) {
        ...
        // kataString = "c"; <------- itu tidak bisa
        // kataString.charAt(0) = "c"; <------- itu tidak bisa
        ...
        // 2. String yang berada di string pool itu aka reuseable, memory lebih efisien
        // 3. membuat string dengan method baru, maka dia akan ditaro
