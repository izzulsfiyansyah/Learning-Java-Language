...
public class Main {
    public static void main(String[] args){
        ...
        // setelah disamakan seperti ini memorinya menjadi sama (memindahkan addresnya)
        arrayAngka2 = arrayAngka1;
        // setelah memorinya menjadi sama
        System.out.println(arrayAngka1);
        System.out.println(arrayAngka2);
    ...
    // ini adalah method arumentnya adalah reference, pass by reference
    // bukan pass by value
